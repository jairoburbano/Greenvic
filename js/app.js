...
//                    $this.find('.loading').css({opacity: 0}).animate({opacity: 1});
    ...
    function validacionExtranet() {
        var formContainer   = $('.extranet__form');
        formContainer.each(function() {
            var $this       = $(this),
                form        = $this,
                formBox     = $this.find('.group'),
            ...
            form.validate({
                ...
                messages: {
                    netname: "Usa solo letras.",
                    netpass: "Usa solo letras."
                },
                errorElement: 'span',
                errorClass: 'form__error',
                validClass: 'form__valid',
